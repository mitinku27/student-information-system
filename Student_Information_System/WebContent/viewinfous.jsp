...
PrintWriter outt=response.getWriter();
		...
		String year=request.getParameter("session");
		...
		try{
			...
			PreparedStatement stmt=con.prepareStatement("select id,department,degree from viewresult where id=? and department=? and year=? and degree=?");
			stmt.setString(1,id);
